...
import bg.o.sim.colourizmus.model.CustomColour.Companion.COLUMN_NAME
import bg.o.sim.colourizmus.model.CustomColour.Companion.TABLE
...
// */
//@Entity(tableName = TABLE, indices = [(Index(value = [COLUMN_NAME], unique = true))])
//class CustomColour(@PrimaryKey val value: Int, var name: String) : Serializable {
//
//    @ColumnInfo(name = COLUMN_IS_FAVOURITE)
//    var isFavourite: Boolean = false
//
